      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        >
          <img
            ...
            alt="ATNX Logo"
            className="h-full object-contain dark:invert-0 light:invert"
          />
        </a>
            ...
            return (
              <a
                ...
                className={`font-mono text-sm tracking-wider hover:text-brand-primary transition-colors duration-300 relative interactive py-2 ${
                  activeSection === id ? "text-brand-primary font-medium" : "text-gray-400 dark:text-gray-400 light:text-gray-600"
                }`}
              >
                {link.name}
                {activeSection === id && (
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="p-2.5 rounded-full border border-white/10 dark:border-white/10 light:border-black/10 glass-panel hover:bg-brand-primary/10 hover:border-brand-primary/30 transition-all duration-300 md:hidden text-gray-300 dark:text-gray-300 light:text-gray-700 interactive"
            ...
            return (
              <a
                ...
                className={`font-heading text-2xl tracking-widest hover:text-brand-primary transition-all duration-300 ${
                  activeSection === id ? "text-brand-primary font-bold scale-110" : "text-gray-300 dark:text-gray-300 light:text-gray-700"
                }`}
              >
                {link.name}
              </a>
