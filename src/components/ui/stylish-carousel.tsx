...
const StylishCarousel = ({
  ...
  return (
    ...
    >
                ...
                <AnimatePresence>
                  {item.title && (
                    <motion.span
                      ...
                      className="text-xs sm:text-sm font-semibold whitespace-nowrap text-white/80 tracking-wide"
                    >
                      {item.title}
                    </motion.span>
                  )}
      ...
      {/* ── CONTROLS ─────────────────────────────────────────────────────── */}
      <div className="mt-8 flex items-center gap-4 px-3 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md shadow-lg">
        {/* Prev */}
        {showArrows && (
          <button
            ...
            className={cn(
              "p-2 rounded-full transition-all hover:bg-white/10 disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer",
              arrowClassName
            )}
          >
      ...
      {/* Counter */}
      <p className="mt-3 text-xs text-white/40 font-medium tabular-nums font-mono">
