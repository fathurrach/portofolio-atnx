...
const statsData: StatItem[] = [
  {
    ...
    sublabel: "Managing systems & infrastructure since 2020",
  },
  {
    id: 2,
    value: 2,
    ...
    sublabel: "Full-stack apps with real users",
  },
  {
    id: 3,
    value: 13,
    suffix: "+",
    label: "Network Sites Managed",
    sublabel: "UniFi infrastructure across locations",
  },
  {
    id: 4,
    value: 10,
    ...
    sublabel: "From scripting to full-stack deployment",
  },
];
